// ISO 3166-1 alpha-2 country codes and English display names.
// Generated from CLDR territory data (Babel), filtered to the 249
// codes that are part of the actual ISO 3166-1 standard (CLDR also
// includes non-standard groupings like the EU, UN, and Kosovo's
// provisional "XK", which are excluded here).
