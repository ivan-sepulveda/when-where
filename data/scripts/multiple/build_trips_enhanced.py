...
ricksteves_traveler.json, davidchang_traveler.json) and one real person's
...
SYNTHETIC_SOURCES = (SYNTHETIC_PATH, BOURDAIN_PATH, RAMSAY_PATH, CONAN_PATH, RICKSTEVES_PATH, GOMEZ_PATH, DAVIDCHANG_PATH)
